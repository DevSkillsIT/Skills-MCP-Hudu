...
1. **Open your browser** and visit:
   ```
   https://mcp.hudu.example.com/token
   ```
   ...
   ```json
   {
     "mcpServers": {
       "hudu": {
         ...
         "args": [
           "mcp-remote",
           "https://mcp.hudu.example.com/mcp",
           "--header",
...
2. Visit `https://mcp.hudu.example.com/token` to get a new token
...
**Token Portal:** `https://mcp.hudu.example.com/token`
