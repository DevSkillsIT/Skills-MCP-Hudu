...
- MCP Server URL: `https://mcp.hudu.example.com`
...
- **Redirect URI:**
  - Platform: **Web**
  - URI: `https://mcp.hudu.example.com/oauth2/callback`
- Click **Register**
...
2. Under **Redirect URIs**, verify:
   - `https://mcp.hudu.example.com/oauth2/callback` ✅
...
**Solution:** Verify redirect URI in Azure AD exactly matches: `https://mcp.hudu.example.com/oauth2/callback`
...
2. **Visit:** `https://mcp.hudu.example.com`
3. **Expected flow:**
   - Redirects to Microsoft login page
   - User enters credentials
   - User consents to permissions (first time only)
   - Redirects back to `https://mcp.hudu.example.com/oauth2/callback`
